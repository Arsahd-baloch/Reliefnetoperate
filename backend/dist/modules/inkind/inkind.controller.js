...
export class InKindController {
    ...
    async createRequest(req, res, next) {
        try {
            const request = await inKindService.createRequest(Number(req.params.id), req.user.id, req.body);
    ...
    async acceptRequest(req, res, next) {
        try {
            const result = await inKindService.acceptRequest(Number(req.params.requestId), req.user.id, req.body);
            res.json(result);
        }
        catch (err) {
            next(err);
    ...
    async completeDonation(req, res, next) {
        try {
    ...
    async getAdminRecords(_req, res, next) {
        try {
...
//# sourceMappingURL=inkind.controller.js.map