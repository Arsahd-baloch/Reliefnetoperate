...
export type AdminCommand = ApproveDonationCommand | RejectDonationCommand | ApproveWithdrawalCommand | RejectWithdrawalCommand | SuspendUserCommand | ReactivateUserCommand | UpdateCampaignStatusCommand | UpdateTaskCommand | VerifyDeliveryCommand | SetSystemStateCommand;
//# sourceMappingURL=admin.command.types.d.ts.map