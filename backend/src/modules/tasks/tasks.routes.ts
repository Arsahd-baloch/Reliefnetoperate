...
router.get(
  '/my',
  authenticate,
  authorize('BENEFICIARY', 'ADMIN', 'NGO', 'DONOR', 'VOLUNTEER', 'COORDINATOR'),
...
router.post(
  ...
  authenticate,
  authorize('COORDINATOR', 'ADMIN'),
  validate({ params: taskIdParam, body: assignTaskSchema }),
  (req, res, next) => tasksController.assign(req, res, next)
);
